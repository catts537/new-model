...
# Live camera input
# ========================
# Use 0 for default webcam OR replace with RTSP/HTTP IP camera URL
camera_source = 0
...
# ========================
frame_counter = 0
skip_rate = 1  # increase to 2 or 3 if FPS drops
...
while True:
    ...
    # YOLO detection
    # ========================
    results = model(frame, imgsz=960, conf=0.5, iou=0.6, device=device, verbose=False)[0]
